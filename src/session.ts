...
import { StrengthExercise, StrengthExerciseCategory, StrengthExerciseListResponse, StrengthExerciseMovement, StrengthExerciseMovementDEP, StrengthExercisePlane, StrengthExerciseResponse, StrengthExercises, StrengthExerciseSorting } from './models/strengthExercise'
...
export abstract class UserSessionBase<UserType extends User = User> {
  ...
  async getStrengthExercises (options: { defaultAlias?: string, category?: StrengthExerciseCategory, movement?: StrengthExerciseMovementDEP, plane?: StrengthExercisePlane, humahMovement?: StrengthExerciseMovement, sort?: StrengthExerciseSorting, ascending?: boolean, limit?: number, offset?: number } = { }) {
