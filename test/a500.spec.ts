...
describe('A500', function () {
  ...
  it('can register machine with facility using JWT', async function () {
    ...
    machineSession = await metricsInstance.authenticateWithMachineInitializerJWTToken({ machineInitializerToken: machineInitializerToken.jwtToken, strengthMachineIdentifier })
  ...
  it('can register machine with facility using OTP', async function () {
    ...
    machineSession = await metricsInstance.authenticateWithMachineInitializerOPTToken({ token: machineInitializerToken.otp, facilityId: machineInitializerToken.facilityId, strengthMachineIdentifier })
